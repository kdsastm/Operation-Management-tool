...
const cardData = [
    { title: "Available Team Members", value: "11" },
    { title: "Primary plotting ending in 30 days", value: "12" },
    { title: "Primary Plotting but 0 % MTD", value: "3" },
  ];
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ backgroundColor: "#112240", borderRadius: "12px", p: 2, position: "relative" }}>
            <IconButton
              ...
              onClick={() => console.log("Full View Clicked")}
            >
              <OpenInFullIcon />
            </IconButton>
